...
const customPalettes = {
    ...
    thff: generatePalette('#008083'),
    thffaccent: generatePalette('#E6F4F1')
};
...
const themes = {
    ...
    'default': {
        primary  : {
            ...customPalettes.thff,
            DEFAULT: customPalettes.thff[600]
            // DEFAULT: colors.indigo[600]
        },
        accent   : {
            ...customPalettes.thffaccent,
            DEFAULT: customPalettes.thffaccent[800]
